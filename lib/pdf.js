...
export async function unduhPDFdariHTML(html, filename) {
  try {
    ...
    // ditempatkan di pojok kiri-atas viewport supaya konten rata atas & tidak ada
    // offset kosong dari posisi scroll halaman (masalah html2canvas pada halaman panjang)
